const abaplintSchema = {
  ...
  "definitions": {
        ...
        "rules": {
          ...
          "properties": {
            ...
            "definitions_top": {
              ...
              "description": "Checks that definitions are placed at the beginning of METHODs and FORMs.\nTags: SingleFile, Quickfix\nhttps://rules.abaplint.org/definitions_top"
            },
            "description_empty": {
              "anyOf": [
                {
            ...
            "many_parenthesis": {
              "anyOf": [
                {
                  "$ref": "#/definitions/ManyParenthesisConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Searches for expressions where extra parenthesis can safely be removed\nTags: SingleFile\nhttps://rules.abaplint.org/many_parenthesis"
            },
            ...
            "select_always_order_by": {
              "anyOf": [
                {
                  "$ref": "#/definitions/SelectAlwaysOrderByConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "SELECTs should always have a ORDER BY clause\n\nThis will make sure that the SELECT statement returns results in the same sequence on different databases\n\nadd ORDER BY PRIMARY KEY if in doubt\nTags: SingleFile\nhttps://rules.abaplint.org/select_always_order_by"
            },
            "select_performance": {
              "anyOf": [
                {
    ...
    "IGlobalConfig": {
      ...
      "properties": {
        "exclude": {
          "description": "list of files to exclude, case insensitive regex",
          "items": {
            "type": "string"
          },
          "type": "array"
