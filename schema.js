const abaplintSchema = {
  ...
  "definitions": {
    ...
    "CDSNamingConf": {
      ...
      "properties": {
        "abstractEntity": {
          "description": "Expected prefix for abstract entities",
          "type": "string"
        },
        "basicInterfaceView": {
          "description": "Expected prefix for basic interface views",
          "type": "string"
        },
        "basicRestrictedReuseView": {
          "description": "Expected prefix for basic restricted reuse views",
          "type": "string"
        },
        "compositeInterfaceView": {
          "description": "Expected prefix for composite interface views",
          "type": "string"
        },
        "compositeRestrictedReuseView": {
          "description": "Expected prefix for composite restricted reuse views",
          "type": "string"
        },
        "consumptionView": {
          "description": "Expected prefix for consumption views",
          "type": "string"
        },
        "derivationFunction": {
          "description": "Expected prefix for derivation functions",
          "type": "string"
        },
        "exclude": {
          "description": "List of file regex filename patterns to exclude, case insensitive",
        ...
        "extensionIncludeView": {
          "description": "Expected prefix for extension include views",
          "type": "string"
        },
        "privateView": {
          "description": "Expected prefix for private views",
          "type": "string"
        },
        "remoteAPIView": {
          "description": "Expected prefix for remote API views",
          "type": "string"
        },
        "severity": {
          "$ref": "#/definitions/Severity",
        ...
        "viewExtend": {
          "description": "Expected prefix for view extends",
          "type": "string"
        }
      },
      "required": [
    ...
    "ClearExportingParametersConf": {
      ...
      "properties": {
        ...
        "skipNames": {
          "description": "Skip specific parameter names, case insensitive",
          "items": {
            "type": "string"
          },
          "type": "array",
    ...
    "DangerousStatementConf": {
      ...
      "properties": {
        ...
        "ignoreRAPQueryProvider": {
          "description": "Ignore dynamic SQL in IF_RAP_QUERY_PROVIDER~SELECT implementations",
          "type": "boolean"
        },
        "insertReport": {
        ...
        "rules": {
          ...
          "properties": {
            ...
            "aff_and_xml": {
              "anyOf": [
                {
                  "$ref": "#/definitions/AFFAndXMLConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks for objects that have both AFF (.json) and XML (.xml) files\nTags: Syntax\nhttps://rules.abaplint.org/aff_and_xml"
            },
            "align_parameters": {
              "anyOf": [
                {
            ...
            "catch_and_raise": {
              "anyOf": [
                {
                  "$ref": "#/definitions/CatchAndRaiseConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Reports CATCH blocks that only re-raise the caught exception without any handling\nTags: SingleFile\nhttps://rules.abaplint.org/catch_and_raise"
            },
            "cds_association_name": {
              "anyOf": [
                {
                  "$ref": "#/definitions/CDSAssociationNameConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "CDS association names should start with an underscore\nTags: SingleFile, Naming\nhttps://rules.abaplint.org/cds_association_name"
            },
            "cds_check_syntax": {
              "anyOf": [
                {
                  "$ref": "#/definitions/CDSCheckSyntaxConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks CDS source, field, type, and semantic annotation references\nTags: Syntax\nhttps://rules.abaplint.org/cds_check_syntax"
            },
            "cds_comment_style": {
              "anyOf": [
                {
            ...
            "cds_field_order": {
              "anyOf": [
                {
                  "$ref": "#/definitions/CDSFieldOrderConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks that CDS key fields are listed first and associations last in the field list\nTags: SingleFile\nhttps://rules.abaplint.org/cds_field_order"
            },
            "cds_legacy_view": {
              "anyOf": [
                {
            ...
            "cds_naming": {
              "anyOf": [
                {
                  "$ref": "#/definitions/CDSNamingConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks CDS naming conventions based on the VDM prefix rules\nTags: SingleFile, Naming\nhttps://rules.abaplint.org/cds_naming"
            },
            "cds_parser_error": {
              "anyOf": [
                {
            ...
            "clear_exporting_parameters": {
              "anyOf": [
                {
                  "$ref": "#/definitions/ClearExportingParametersConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks that EXPORTING parameters passed by reference are cleared or assigned before they are read\nTags: Styleguide\nhttps://rules.abaplint.org/clear_exporting_parameters"
            },
            "cloud_types": {
              "anyOf": [
                {
            ...
            "fm_global_parameters_obsolete": {
              ...
              "description": "Check for function modules with global parameters\nhttps://rules.abaplint.org/fm_global_parameters_obsolete"
            },
            ...
            "method_length": {
              ...
              "description": "Checks relating to method/form/function module length.\nTags: Styleguide, SingleFile\nhttps://rules.abaplint.org/method_length"
            },
            ...
            "no_comments_between_methods": {
              ...
              "description": "It's not possible to have comments between methods in global classes.\nTags: SingleFile, Syntax\nhttps://rules.abaplint.org/no_comments_between_methods"
            },
            "no_dynamic_stuff": {
              "anyOf": [
                {
                  "$ref": "#/definitions/NoDynamicStuffConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Detects dynamic calls and other dynamic language constructs\nTags: SingleFile, Security\nhttps://rules.abaplint.org/no_dynamic_stuff"
            },
            "no_exclamation_escape": {
              "anyOf": [
                {
                  "$ref": "#/definitions/NoExclamationEscapeConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Detects and removes exclamation marks (!) used to escape identifiers\nTags: SingleFile, Quickfix\nhttps://rules.abaplint.org/no_exclamation_escape"
            },
            ...
            "no_macros": {
              "anyOf": [
                {
                  "$ref": "#/definitions/NoMacrosConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks that macros are not used\nTags: SingleFile\nhttps://rules.abaplint.org/no_macros"
            },
            "no_mandt_in_database_operations": {
              "anyOf": [
                {
                  "$ref": "#/definitions/NoMandtInDatabaseOperationsConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Do not specify the client in database operations; the ABAP runtime handles it automatically.\nTags: SingleFile, Syntax\nhttps://rules.abaplint.org/no_mandt_in_database_operations"
            },
            "no_prefixes": {
              "anyOf": [
                {
            ...
            "parser_bad_exceptions": {
              "anyOf": [
                {
                  "$ref": "#/definitions/ParserBadExceptionsConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks for syntax not recognized by abaplint, related to EXCEPTIONS in CALL FUNCTION.\nTags: Syntax, SingleFile\nhttps://rules.abaplint.org/parser_bad_exceptions"
            },
            "parser_error": {
              "anyOf": [
                {
            ...
            "prefer_abap_bool": {
              "anyOf": [
                {
                  "$ref": "#/definitions/PreferAbapBoolConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Use abap_bool instead of XFELD, SAP_BOOL, BOOLE_D, FLAG for boolean variables\nTags: Styleguide, SingleFile, Quickfix\nhttps://rules.abaplint.org/prefer_abap_bool"
            },
            "prefer_abap_bool_values": {
              "anyOf": [
                {
                  "$ref": "#/definitions/PreferAbapBoolValuesConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Use abap_true and abap_false instead of 'X' and ' ' for abap_bool variables\nTags: Styleguide, SingleFile, Quickfix\nhttps://rules.abaplint.org/prefer_abap_bool_values"
            },
            ...
            "prefer_insert_into_table": {
              "anyOf": [
                {
                  "$ref": "#/definitions/PreferInsertIntoTableConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Prefer INSERT INTO TABLE over APPEND\nTags: SingleFile, Styleguide, Quickfix\nhttps://rules.abaplint.org/prefer_insert_into_table"
            },
            "prefer_is_not": {
              "anyOf": [
                {
            ...
            "prefer_string_template": {
              "anyOf": [
                {
                  "$ref": "#/definitions/PreferStringTemplateConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Use string templates instead of && to assemble text\nTags: Styleguide, SingleFile, Quickfix\nhttps://rules.abaplint.org/prefer_string_template"
            },
            "prefer_xsdbool": {
              "anyOf": [
                {
            ...
            "redundant_conversion": {
              "anyOf": [
                {
                  "$ref": "#/definitions/RedundantConversionConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Find redundant CONV expressions\nTags: Quickfix\nhttps://rules.abaplint.org/redundant_conversion"
            },
            "release_idoc": {
              "anyOf": [
                {
            ...
            "selection_screen_texts_missing": {
              "anyOf": [
                {
                  "$ref": "#/definitions/SelectionScreenTextsMissingConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks that selection screen parameters and select-options have selection texts\nhttps://rules.abaplint.org/selection_screen_texts_missing"
            },
            "sequential_blank": {
              "anyOf": [
                {
            ...
            "sy_read_restriction": {
              "anyOf": [
                {
                  "$ref": "#/definitions/SyReadRestrictionConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Finds reads of SY fields not allowed in the current language version\nTags: SingleFile\nhttps://rules.abaplint.org/sy_read_restriction"
            },
            ...
            "unnecessary_loop_guard": {
              "anyOf": [
                {
                  "$ref": "#/definitions/UnnecessaryLoopGuardConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Detects unnecessary IS [NOT] INITIAL check before LOOP AT\nTags: SingleFile, Styleguide, Quickfix\nhttps://rules.abaplint.org/unnecessary_loop_guard"
            },
            "unnecessary_pragma": {
              "anyOf": [
                {
            ...
            "use_message_class": {
              "anyOf": [
                {
                  "$ref": "#/definitions/UseMessageClassConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Define messages in SE91 instead of using inline text or variables\nTags: Styleguide, SingleFile\nhttps://rules.abaplint.org/use_message_class"
            },
            "use_new": {
              "anyOf": [
                {
            ...
            "wrong_abapdoc_position": {
              "anyOf": [
                {
                  "$ref": "#/definitions/WrongAbapdocPositionConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "ABAP Doc must be placed directly in front of the declaration it documents.\nTags: SingleFile\nhttps://rules.abaplint.org/wrong_abapdoc_position"
            },
            "xml_bom": {
              "anyOf": [
                {
                  "$ref": "#/definitions/XMLBOMConf"
                },
                {
                  "type": "boolean"
                }
              ],
              "description": "Checks that XML files start with a UTF-8 byte order mark\nTags: Syntax, Quickfix\nhttps://rules.abaplint.org/xml_bom"
            },
            "xml_consistency": {
              "anyOf": [
                {
              ...
              "description": "Checks the consistency of main XML files\nTags: Naming, Syntax\nhttps://rules.abaplint.org/xml_consistency"
            }
          },
          "type": "object"
        },
    ...
    "IGlobalConfig": {
      "additionalProperties": false,
      "properties": {
        "errorOnDuplicateFilenames": {
          "description": "Throw an error if multiple files with the same filename are added to the registry, ignores package.devc.xml",
          "type": "boolean"
        },
        "exclude": {
    ...
    "ISyntaxSettings": {
      ...
      "properties": {
        "ambigiousVoids": {
          "description": "List of names to void in ambigious statements (regex not possible)",
          "items": {
            "type": "string"
          },
          "type": "array",
        ...
        "version": {
          "$ref": "#/definitions/VersionOldOrNew",
    ...
    "LanguageVersion": {
      "description": "Dialect / flavor axis, orthogonal to the on-prem/cloud release track.\n\n`Normal`  = full ABAP, no restrictions. `Cloud`   = restricted ABAP for Cloud, syntactic and semantic restrictions apply. `KeyUser` = stricter still (KeyUser Extensibility), strict subset of Cloud.\n\nOrdering: KeyUser(0) &lt; Cloud(1) &lt; Normal(2) — lower = more restrictive.",
      "enum": [
        "Normal",
        "KeyUser",
        "Cloud"
    ...
    "MethodLengthConf": {
      ...
      "properties": {
        ...
        "checkFunctionModules": {
          "description": "Option to check function modules.",
          "type": "boolean"
        },
        "errorWhenEmpty": {
          "description": "Checks for empty methods/forms/function modules.",
          "type": "boolean"
        },
        "exclude": {
          "description": "List of file regex filename patterns to exclude, case insensitive",
        ...
        "statements": {
          "description": "Maximum method/form/function module length in statements.",
          "type": "number"
        }
      },
      "required": [
    ...
    "NoAliasesConf": {
      ...
      "properties": {
        ...
        "ignorePrivate": {
          "description": "Skip reporting aliases in private sections.",
          "type": "boolean"
        },
        "severity": {
          "$ref": "#/definitions/Severity",
    ...
    "NoDynamicStuffConf": {
      ...
      "properties": {
        "assign": {
          "description": "Detects dynamic ASSIGN, including ASSIGN COMPONENT",
          "type": "boolean"
        },
        "callDatabaseProcedure": {
          "description": "Detects CALL DATABASE PROCEDURE, the procedure name is always dynamic",
          "type": "boolean"
        },
        "callFunction": {
          "description": "Detects dynamic CALL FUNCTION, ie. the function module name is not a literal",
          "type": "boolean"
        },
        "callMethod": {
          "description": "Detects dynamic method calls, ie. CALL METHOD (name), SET HANDLER and CALL BADI",
          "type": "boolean"
        },
        "callTransaction": {
          "description": "Detects dynamic CALL TRANSACTION, ie. the transaction code is not a literal",
          "type": "boolean"
        },
        "callTransformation": {
          "description": "Detects dynamic CALL TRANSFORMATION",
          "type": "boolean"
        },
        "createData": {
          "description": "Detects dynamic CREATE DATA",
          "type": "boolean"
        },
        "createObject": {
          "description": "Detects dynamic CREATE OBJECT",
          "type": "boolean"
        },
        "exclude": {
          "description": "List of file regex filename patterns to exclude, case insensitive",
        ...
        "exportImport": {
          "description": "Detects dynamic EXPORT and IMPORT",
          "type": "boolean"
        },
        "getBadi": {
          "description": "Detects dynamic GET BADI",
          "type": "boolean"
        },
        "internalTable": {
          "description": "Detects dynamic internal table access, ie. dynamic WHERE, keys, SORT BY and TRANSPORTING",
          "type": "boolean"
        },
        "perform": {
          "description": "Detects dynamic PERFORM",
          "type": "boolean"
        },
        "severity": {
          "$ref": "#/definitions/Severity",
        ...
        "submit": {
          "description": "Detects dynamic SUBMIT",
          "type": "boolean"
        }
      },
      "required": [
    ...
    "NoMandtInDatabaseOperationsConf": {
      "additionalProperties": false,
      "properties": {
        "exclude": {
          "description": "List of file regex filename patterns to exclude, case insensitive",
    ...
    "ReleaseName": {
      "description": "Union of all raw release name strings, e.g. `\"v700\" | \"v758\" | \"Newest\"`.",
      "enum": [
        "v700",
        "v701",
        "v702",
    ...
    "SelectionScreenTextsMissingConf": {
      "additionalProperties": false,
      "properties": {
        "exclude": {
          "description": "List of file regex filename patterns to exclude, case insensitive",
    ...
    "XMLConsistencyConf": {
      ...
      "properties": {
        "dataElementSeverity": {
          "$ref": "#/definitions/Severity",
          "description": "Problem severity for data element(DTEL) field checks"
        },
        "exclude": {
          "description": "List of file regex filename patterns to exclude, case insensitive",
          "items": {
        ...
        "textAndTranslationLengthSeverity": {
          "$ref": "#/definitions/Severity",
          "description": "Problem severity for text and translation length checks"
        }
      },
      "type": "object"
    }
